...
"""
This program is a molar mass calculator, a program that computes
the molar mass of a substance and the number of moles of a sample of that substance.
"""

def main():
    # periodic_table_dict = make_periodic_table()
    # i = 0
    # while i < len(periodic_table_dict):
    #     periodic_table = periodic_table_dict[i]
    #     print(f'{periodic_table[1]} {periodic_table[2]}')
    #     i += 1
    # return 
