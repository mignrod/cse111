...
def main():
    ...
    print()
    count_marriage(marriages_dict, people_dict)
...
def count_genders(people_dict):
    ...
    print(f'Numbers of Males: {male}')
    print(f'Numbers of Females: {female}')
...
def print_marriages(marriages_dict, people_dict):
    ...
    """
    print('Marriages')
    for key, marriages_list in marriages_dict.items():
        husband_key = marriages_list[HUSBAND_KEY_INDEX]
        year = marriages_list[WEDDING_YEAR_INDEX]
        wife_key = marriages_list[WIFE_KEY_INDEX]
...
def count_marriage(marriages_dict, people_dict):
    ...
    for marriages_key, marriages_list in marriages_dict.items():
        husband_key = marriages_list[HUSBAND_KEY_INDEX]
        wife_key = marriages_list[WIFE_KEY_INDEX]
    ...
    for people_key, people_list in people_dict.items():
        ...
        num_marriges = people_list[NUM_MARRIAGES_INDEX]

        if num_marriges > 0:
            print(name, num_marriges)
