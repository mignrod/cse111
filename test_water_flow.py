...
def test_kPa_to_Psi():
    assert kPa_to_Psi(1) == approx(0.145, abs=0.001)
    assert kPa_to_Psi(1.3) == approx(0.188, abs=0.001)
    assert kPa_to_Psi(0) == approx(0, abs=0.001)
    assert kPa_to_Psi(2) == approx(0.290, abs=0.001)
    assert kPa_to_Psi(3.7) == approx(0.536, abs=0.001)
    assert kPa_to_Psi(125) == approx(18.125, abs=0.001)
